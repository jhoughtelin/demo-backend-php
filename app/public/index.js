...
async function backupPrivateKeys() {
    await alice.backupPrivateKey(`pkeypassword`);
    await bob.backupPrivateKey(`pkeypassword`);
}
...
async function restorePrivateKeys() {
    await alice.restorePrivateKey(`pkeypassword`);
    await bob.restorePrivateKey(`pkeypassword`);
}
